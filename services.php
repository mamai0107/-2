 ...
 <body>
	...
	<div class="services">
        <div class="studio_h">Цены на пошив свадебных платьев</div>
        <div class="services_inner">
            <div class="services_item">
                <div class="services_left">Пошив платья</div>
                <div class="services_right">от 16000</div>
            </div>
            <div class="services_item">
                <div class="services_left">Фата короткая/до спины/в пол</div>
                <div class="services_right">2000/4000/6000</div>
            </div>
            <div class="services_item">
                <div class="services_left">Стоимость материала</div>
                <div class="services_right">от 2000</div>
            </div>
            <div class="services_item">
                <div class="services_left">Консультация дизайнера</div>
                <div class="services_right">Бесплатно</div>
            </div>
            <div class="services_item">
                <div class="services_left">Выезд</div>
                <div class="services_right">бесплатный</div>
            </div>
            <div class="services_item">
                <div class="services_left">Срок пошива</div>
                <div class="services_right">3 недели</div>
            </div>
            <div class="services_item">
                <div class="services_left">Корест</div>
                <div class="services_right">4000</div>
            </div>
            <div class="services_item">
                <div class="services_left">Дополнительные аксесуары</div>
                <div class="services_right">от 3000</div>
            </div>
        </div>
    </div>
